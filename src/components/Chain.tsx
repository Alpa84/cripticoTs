              ...
              >
                <div
                  ...
                  className={`card border-primary ${
                    general.editableChain && !blockValidation.isValid
                      ? 'invalidBlock'
                      : ''
                  }`}
                >
                    ...
                    {general.editableChain ? (
                      <>
                        ...
                        <button
                          type="button"
                          onClick={() => {
                            functions.dispatch({ type: 'removeBlock', index })
                          }}
                        ...
                        <Input
                          text="nonce"
                          value={general.editableChain[index].nonce}
                          onChange={(event) =>
                            functions.dispatch({
                        ...
                        <button
                          type="button"
                          className="btn btn-secondary"
                          onClick={() => functions.findNonce(block, index)}
                        >
                          Search Nonce
                        </button>
                        <div className="card">
                        ...
                        <Input
                          ...
                          value={general.editableChain[index].previousBlockHash}
                          onChange={(event) =>
                            functions.dispatch({
